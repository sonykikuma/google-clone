    ...
    <div className="">
      ...
      <form className="flex flex-col items-center mt-40">
        ...
        <div
         ...
         border-gray-200 hover:shadow-lg focus-within:shadow-lg px-5 py-3 rounded-full
        ...
        <div
          className="flex flex-col sm:flex-row w-[50%] space-y-2 mt-8 sm:space-y-0
        sm:space-x-4 justify-center"
        >
